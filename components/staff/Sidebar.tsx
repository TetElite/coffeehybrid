...
import { LayoutDashboard, QrCode, Home, Coffee, LogOut, Menu, X } from 'lucide-react';
...
const navLinks = [
    { href: '/staff', label: 'Order Queue', icon: LayoutDashboard },
    { href: '/staff/scan', label: 'QR Scanner', icon: QrCode },
        ...
        <div className="flex flex-col h-full bg-card/60 backdrop-blur-xl border-r border-border/40 p-6 space-y-8">
            <div className="flex items-center gap-3 px-2">
                ...
                <div className="font-black text-xl tracking-tighter">
                    STAFF<span className="text-primary italic">HUB</span>
                </div>
            </div>
            ...
            <div className="pt-8 border-t border-border/40 px-2 space-y-4">
                <div className="p-4 rounded-3xl bg-primary/5 border border-primary/10">
                    <p className="text-[10px] font-black uppercase text-primary tracking-widest mb-1.5 opacity-60">System Status</p>
                    <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                        <span className="text-xs font-bold text-foreground/80">Verifying Connections</span>
                    </div>
                </div>
                <Button
                    variant="ghost"
